...
//using an interface to talk to chainlink for the price feed 
import {AggregatorV3Interface} from "@chainlink/contracts/src/v0.8/shared/interfaces/AggregatorV3Interface.sol";

//creating a library to use in the FundMe contract to convert prices 
library PriceConverter {
    //function to get the price of etherum in terms of USD as a uint256
    ...
    function getConversionRate(uint256 ethAmount) internal view returns(uint256) {
        ...
        //dividing by 18 because both of them have 18 decimal places
    ...
    //getVersion just asks the chainlink price-feed contract which aggregator version it is running
